...
import java.io.IOException;
        /*
         *   9)	Realizar un programa Java (nombre del fichero: AC11Eje9.java) que muestra el uso de algunos métodos
         *      de la clase File:
         *      a.	Crear un objeto File ruta asociado al directorio c:/ficheros y un objeto File f asociado al fichero
         *          datos.txt que se encuentra en ese directorio.
         *      b.	Si el fichero no existe se crea y si el directorio no existe se crea y a continuación se crea
         *          el fichero. Si el fichero existe se muestra el tamaño del mismo.
         */
